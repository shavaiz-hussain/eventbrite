...
from django.forms import DateTimeField, MultiWidget, TextInput
...
class EventForm(forms.Form):
    ...
    inventory_tier = forms.CharField(
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Inventory Tier"}
        )
    )
    ticket_price = forms.IntegerField(
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Ticket Price"}
        )
    )
    ticket_capacity = forms.IntegerField(
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Ticket Capacity"}
        )
    )
